...
## MassCenter: the visual is brief enough that planet rotation is invisible.
...
# next to MassCenter's 6371 km, and a faithful-scale explosion would be
...
## readability against MassCenter.
